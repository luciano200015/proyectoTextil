...
export const ListaModelo=()=> {
    ...
    const deleteTipoMPrima = async() => {
        const response=await Axios.delete(`http://localhost:3001/deletemodelo/${id}`)
    ...
    return (
        <div className='container mt-5'>
            <div className='row mt-5'>
                <div className='col-md-6 mt-5'><h2>Lista de Modelos</h2></div>
                
                <AlertComponent message={"error al eliminar" } error={errorEliminar} seterror={seterrorEliminar} severity="error"/>
                
                <div className='col-md-8 '>
                    <ListaTipoMateriaPrima TipoMateriaPrima={TipoMateriaPrima} eliminar={handleClickOpen} urlupdate="updatemodelo"/>
                </div>
                <br/>
                <div className='col-md-8'>
                    <Button variant="outlined" sx={{width:"15rem",marginTop:"1rem"}} component={Link} to={`/createmodelo`}>Añadir Nuevo Tipo</Button>
                </div>
